# 06. Management command'lar dokumentatsiyasi
...
**Vazifasi:** MovieLens 100K dataset'dan genre, movie, synthetic user va ratinglarni bazaga kiritadi.
...
```bash
python manage.py seed_movielens --path=ml-100k --user-prefix=ml100k_user_
```
...
**Vazifasi:** movie yozuvlarini TMDB orqali metadata bilan boyitadi.
...
**Vazifasi:** missing posterlarni TMDB orqali to'ldiradi.
...
## 6.4. Qaysi command qachon ishlatiladi?
...
### Faqat posterlar yetishmayotgan bo'lsa
